    ...
    <>
      ...
      <section className="mx-auto flex max-w-site flex-col gap-[112px] px-10 py-32 max-[620px]:px-6 max-[620px]:py-[72px]">
        <div className="flex items-end gap-10 max-[1000px]:flex-col max-[1000px]:items-start max-[1000px]:gap-8">
          <h1 className="flex-1 text-[clamp(40px,4.6vw,64px)] font-medium leading-[1.12] tracking-[-1px] text-ink">Grid-Scale Storage for<br />Bangladesh&apos;s Energy Future.</h1>
        ...
        <div className="mx-auto flex max-w-site flex-col gap-10 px-10 max-[620px]:px-6">
          ...
          <div className="flex flex-col gap-14">
            <div className="flex flex-col gap-5">
              <h2 className="text-[clamp(40px,4.4vw,56px)] font-medium leading-[1.14] tracking-[-1px] text-ink">Built for the People Who Build the Grid</h2>
            ...
            <div className="flex flex-wrap gap-3">
              {AUDIENCE.map((a) => (<span key={a} className="rounded-full border border-ink px-6 py-3 text-lg font-medium leading-6 text-ink">{a}</span>))}
            </div>
      ...
      <section id="capabilities" className="bg-ink py-32 text-white max-[620px]:py-[72px]">
        <div className="mx-auto flex max-w-site flex-col items-center gap-16 px-10 max-[620px]:px-6">
          <div className="flex flex-col items-center gap-4">
            ...
            <h2 className="text-center text-[clamp(40px,4.4vw,56px)] font-medium leading-[1.14] tracking-[-1px] text-white">Storage That Strengthens the Grid</h2>
          </div>
          <div className="flex w-full gap-5 max-[1000px]:flex-wrap">
            {CAPS.map(([icon, t, d]) => (
      ...
      <section className="px-10 py-16 max-[620px]:px-6">
        <div className="mx-auto flex max-w-site gap-20 max-[1000px]:flex-col max-[1000px]:gap-8">
          <div className="flex flex-1 flex-col gap-10">
            ...
            <div className="flex flex-col gap-4">
              <h2 className="text-[clamp(40px,4.4vw,56px)] font-medium leading-[1.14] tracking-[-1px] text-ink">Tender-Ready, From Bid to Commissioning</h2>
